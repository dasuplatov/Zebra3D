...
See PDF files for complehensive tutorial. Zebra3D-1.0.tar.gz and Zebra3D-1.1.tar.gz - Zebra3D code for v. 1.0 and v. 1.1. Zebra3D_case_studies_input.tar.gz - benchmark cases
